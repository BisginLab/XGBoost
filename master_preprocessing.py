...
def create_standardized_data_and_indices(
    ...
    metadata = {
        ...
        'data_checksum': hashlib.md5(df_clean.to_string().encode()).hexdigest()
    }
...
def verify_data_consistency(data_dir: str = './standardized_data') -> bool:
    ...
    try:
        ...
        # Verify checksum
        current_checksum = hashlib.md5(df_clean.to_string().encode()).hexdigest()
...
if __name__ == "__main__":
    # Example usage
    csv_path = "./content/sample_data/corrected_permacts.csv"  # Update this path
